...
const emptyForm = { year: "", title: "", venue: "", description: "", imageUrl: "", sortOrder: "0" };
  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-8">
        ...
        <button onClick={() => { setShowForm(true); setEditId(null); setForm(emptyForm); }} className="px-6 py-2.5 rounded-lg text-[13px] font-semibold tracking-wide transition-all hover:shadow-lg" style={{ background: "linear-gradient(135deg, var(--gold), var(--gold2))", color: "#1A1830" }}>+ Add Exhibition</button>
      </div>
      ...
      <div className="rounded-xl border overflow-hidden" style={{ background: "var(--bg-card)", borderColor: "var(--border)" }}>
        <table className="w-full text-[14px]">
          ...
          <tbody>
            ...
            {items.length === 0 && <tr><td colSpan={5} className="px-6 py-12 text-center" style={{ color: "var(--text3)" }}>No exhibitions yet. Click &quot;+ Add Exhibition&quot; to get started.</td></tr>}
          </tbody>
        </table>
      </div>
    </div>
